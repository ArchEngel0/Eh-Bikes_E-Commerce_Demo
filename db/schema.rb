...
ActiveRecord::Schema[7.1].define(version: 2023_12_05_215042) do
  ...
  create_table "user_provinces", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "province_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["province_id"], name: "index_user_provinces_on_province_id"
    t.index ["user_id"], name: "index_user_provinces_on_user_id"
  end
